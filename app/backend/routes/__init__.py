...
from app.backend.routes.algo_trader import router as algo_trader_router
from app.backend.routes.connections import router as connections_router
...
api_router.include_router(algo_trader_router)
